...
export const appName = 'Nexthomelabs Sign';
...
export const mailTemplate = param => {
  ...
  const logo = `<img src='https://i.ibb.co/HNHDVZS/nhl934-e559d97359102662b413-1.png' height='50' />`;

  const opurl = ` <a href='https://www.nexthomelabssign.com' target=_blank>here</a>`;
  ...
  const body =
    ...
    logo +
    `</div><div style='padding:2px;font-family:system-ui;background-color:${themeColor}'><p style='font-size:20px;font-weight:400;color:white;padding-left:20px'>Digital Signature Request</p></div><div>` +
    `<p style='padding:20px;font-size:14px;margin-bottom:10px'>` +
    param.senderName +
