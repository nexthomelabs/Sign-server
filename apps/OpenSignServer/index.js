...
const supabaseUrl = process.env.SUPABASE_URL || 'https://johwixbrrrloijuwtnsh.supabase.co';
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpvaHdpeGJycnJsb2lqdXd0bnNoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NjMxODA1NSwiZXhwIjoyMDYxODk0MDU1fQ.nSHKF8pAprbna9ZpPR4guaXUi0FTVql0OWA8cr4Heeo';
...
export const config = {
  databaseURI:
    process.env.DATABASE_URI || process.env.MONGODB_URI || 'mongodb://localhost:27017/NexthomelabsSignDB',
  cloud: function () {
    import('./cloud/main.js');
  },
  appId: process.env.APP_ID || 'nexthomelabs-sign',
  logLevel: ['error'],
  maxLimit: 500,
  maxUploadSize: '30mb',
...
app.get('/', function (req, res) {
  res.status(200).send('nexthomelabs-sign-server is running !!!');
});
...
if (!process.env.TESTING) {
  ...
  httpServer.listen(port, '0.0.0.0', function () {
    console.log('nexthomelabs-sign-server running on port ' + port + '.');
